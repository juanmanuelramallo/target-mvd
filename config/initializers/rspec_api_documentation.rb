...
RspecApiDocumentation.configure do |config|
  ...
  config.request_headers_to_include = ['access-token', 'uid', 'client']
  config.response_headers_to_include = ['access-token', 'expiry', 'token-type', 'uid', 'client']
